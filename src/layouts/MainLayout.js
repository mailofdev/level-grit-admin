...
const MainLayout = ({ children, config }) => {
  ...
  return (
    <div className="d-flex flex-column min-vh-100 theme-transition">
      ...
      <div className="container-fluid flex-grow-1 pt-3 pt-md-4 pt-lg-4 pb-5 pb-md-5 pb-lg-0" style={{ paddingTop: 'calc(4rem + env(safe-area-inset-top))', paddingBottom: 'calc(5rem + env(safe-area-inset-bottom))' }}>
